...
String apiKey = "Q2CNRULVYWWXWX08";  //Write API key from ThingSpeak

const char *ssid =  "MySpectrumWiFi04-2G";  // WiFi SSID
const char *pass =  "happyroad218";         // WiFi WPA2 Passkey
